...
* 🤔 `:thinking:` - This should be used for questions or requests for clarification. This can sometimes be blocking, depending on the nature of the question and scenario, but typically these are non-blocking, and should be used for help in learning, and just generally understanding the nature or intent of the code.
* ❓ `:question:` - This is an alternative to the previous (thinking) SLI, and should be considered an equal option, or alias. The two can be used interchangeably for questions.
