...
Code reviews are an important part of the <abbr title="Software Development Life Cycle">SDLC</abbr> and code quality; they are a critical part of the process of introducing both new code and/or changes to existing code into the codebase of a project. Code reviews serve several purposes:
...
- https://gist.github.com/AliMD/3344523 (for reference, remove before publish)
- https://api.github.com/emojis (for reference, remove before publish)
...
* 🛡 `:shield:` - this is a **blocking issue**, and identifies a (potential?) security issue, and must be corrected before the PR will be approved. Comments with this SLI should always include a recommendation for what and how to correct the issue.

----

All PRs will only be merged after passing the QA process and having 2 approved reviews from developers that did not contribute to the PR.
