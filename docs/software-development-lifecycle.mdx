...
1. Ready For Development
    ...
    * When an engineer is ready for a new story they will take one from this column and assign it to the current iteration
    * Creating a Git branch referencing the story ID will automatically move the story to the **In Development** column
1. In Development
...
1. QA Ready
    ...
    * The engineer opens a Pull Request from their feature branch into `develop`
