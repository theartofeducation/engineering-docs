...
Before you will be able to public the package to the npm registry, you will need to be logged in to it. You can login with the following command:

```sh
yarn npm login --scope aoeu
```
